...
--
-- Name: customer_order_product; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.customer_order_product AS
 SELECT cs.company_name,
    ps.product_name,
    ods.unit_price,
    ods.quantity
   FROM (((public.order_details ods
     JOIN public.orders os ON ((os.order_id = ods.order_id)))
     JOIN public.customers cs ON (((os.customer_id)::text = (cs.customer_id)::text)))
     JOIN public.products ps ON ((ods.product_id = ps.product_id)));
...
CREATE TABLE public.regions (
    ...
    region_description character varying(255)
);
...
ALTER TABLE ONLY public.employee_territories
    ADD CONSTRAINT employee_territories_employee_id_fkey FOREIGN KEY (employee_id) REFERENCES public.employees(employee_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.employee_territories
    ADD CONSTRAINT employee_territories_territory_id_fkey FOREIGN KEY (territory_id) REFERENCES public.territories(territory_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_employee_id_fkey FOREIGN KEY (employee_id) REFERENCES public.employees(employee_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.territories
    ADD CONSTRAINT territories_region_id_fkey FOREIGN KEY (region_id) REFERENCES public.regions(region_id) ON DELETE CASCADE;
